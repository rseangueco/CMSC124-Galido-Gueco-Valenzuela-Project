...
separatedkeywords = ["I", "HAS", "A", "SUM", "DIFF", "PRODUKT", "QUOSHUNT", "MOD", "BIGGR", "SMALLR", "BOTH", "ANY", "ALL", "OF", "SAEM", "NOW", "O", "RLY", "YA", "RLY?", "NO", "WAI", "IM", "IN", "OUTTA", "YR", "HOW", "IF", "U", "SAY", "SO", "FOUND", "IZ"]
